  ...
  return (
    <aside className="sidebar py-5">
      ...
      <div className="box">
        ...
        <FormControlLabel control={<Checkbox size='small'/>} label="In Stock (23)" className="w-full"/>
      ...
      <div className="box mt-4">
        ...
        <div className="box mt-4">
        <h3 className="mb-3 text-[16px] font-[600] flex items-center pr-5">Filter by Rating
